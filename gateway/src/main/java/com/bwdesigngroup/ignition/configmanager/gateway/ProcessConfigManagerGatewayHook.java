 ...
 */
public class ProcessConfigManagerGatewayHook extends AbstractGatewayModuleHook {
    ...
    public void startup(LicenseState activationState) {
        logger.info("Starting up Process Config Manager module.");
    }
    ...
    public void shutdown() {
        logger.info("Shutting down Process Config Manager module.");
    }
